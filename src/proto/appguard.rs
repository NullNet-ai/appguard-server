...
pub mod app_guard_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn register_device(
            &mut self,
            request: impl tonic::IntoRequest<super::AuthorizationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AuthenticationData>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/appguard.AppGuard/RegisterDevice",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("appguard.AppGuard", "RegisterDevice"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn heartbeat(
            &mut self,
            request: impl tonic::IntoRequest<super::AuthenticationData>,
        ) -> std::result::Result<
...
pub mod app_guard_server {
    ...
    pub trait AppGuard: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn register_device(
            &self,
            request: tonic::Request<super::AuthorizationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AuthenticationData>,
            tonic::Status,
        >;
        ...
        async fn heartbeat(
            &self,
            request: tonic::Request<super::AuthenticationData>,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/appguard.AppGuard/RegisterDevice" => {
                    ...
                    struct RegisterDeviceSvc<T: AppGuard>(pub Arc<T>);
                    impl<
                        T: AppGuard,
                    > tonic::server::UnaryService<super::AuthorizationRequest>
                    for RegisterDeviceSvc<T> {
                        type Response = super::AuthenticationData;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AppGuard>::register_device(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/appguard.AppGuard/Heartbeat" => {
                    ...
                    impl<
                        T: AppGuard,
                    > tonic::server::ServerStreamingService<super::AuthenticationData>
                    for HeartbeatSvc<T> {
