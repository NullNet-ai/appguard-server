...
pub mod app_guard_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn sample(
            ...
            let path = http::uri::PathAndQuery::from_static("/appguard.AppGuard/Sample");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("appguard.AppGuard", "Sample"));
...
pub mod app_guard_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/appguard.AppGuard/Sample" => {
                    #[allow(non_camel_case_types)]
                    struct SampleSvc<T: AppGuard>(pub Arc<T>);
                    impl<T: AppGuard> tonic::server::UnaryService<super::SampleMessage>
                    for SampleSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AppGuard>::sample(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
